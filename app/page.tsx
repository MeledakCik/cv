  ...
  return (
    <main className="min-h-screen bg-[#0d0f14] text-white">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden border-b border-white/5">
        ...
        <div className="relative z-10 text-center px-4">
          <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 px-4 py-1.5 rounded-full text-primary text-xs font-bold uppercase tracking-widest mb-6">
            <Flame size={14} />Tanggal Dibuat | 11.Apr.2024 Point Blank Indonesia
          </div>
          <h1 className="text-6xl md:text-8xl font-black italic tracking-tighter uppercase">
            Mc`Donalds <span className="text-primary">CLAN</span>
          </h1>
          <p className="mt-4 text-gray-400 max-w-2xl mx-auto text-lg italic">
            "I'm Lovin' It, I'm Killin' It." Lebih dari sekadar clan, kami adalah keluarga yang mendominasi setiap medan tempur.
          </p>
      ...
      <div className="container mx-auto px-4 py-20">
        {/* Stats Grid - Kekuatan Clan */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-24">
          <StatsCard icon={<Trophy className="text-primary" />} label="Rank" value="BlackOps Battalion" />
          <StatsCard icon={<Target className="text-primary" />} label="Win Rate" value="96.3%" />
          <StatsCard icon={<Users className="text-primary" />} label="Total Members" value="94/250" />
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
          <div>
            ...
            <div className="space-y-4 text-gray-400 leading-relaxed">
              <p>
                Berawal dari sekumpulan pemain publik yang sering bermain bersama, <strong>Mc`Donalds Clan</strong> dibentuk dengan visi menciptakan komunitas yang solid, kompetitif, namun tetap santai seperti nongkrong di resto favorit.
              </p>
              <p>
                Kami fokus pada gameplay taktis di mode Bomb Mission dan menjunjung tinggi kejujuran. Di sini, skill memang penting, tapi loyalitas adalah segalanya. Kami tidak memberikan ruang bagi pengguna program ilegal.
              </p>
            </div>
          </div>
          <div className="bg-white/5 border border-white/10 p-8 rounded-3xl relative">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex gap-3">
                <div className="mt-1.5 h-2 w-2 rounded-full bg-primary shrink-0" />
                <p className="text-sm text-gray-300">Mencetak pemain-pemain bermental juara dan sportif.</p>
              </li>
            </ul>
          </div>
        </div>

        {/* Menu/Link Cepat - Pengganti Card */}
